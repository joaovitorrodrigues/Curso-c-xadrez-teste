...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        public void DesfazMovimento(Posicao origem, Posicao destino, Peca peca)
        {
            ...
            if(p is Peao)
            {
                if(origem.Coluna != destino.Coluna && peca == VulneravelEnPassant)
                {
        ...
        public void ValidarPocisaoOrigem(Posicao pos)
        {
